...
def luma_next_data_london(events: list[dict]) -> str:
    payload = {
        "props": {
            "pageProps": {
                "initialData": {
...
def luma_offline_ai_item(api_id: str = "evt-test1", slug: str = "enterprise-ai-summit") -> dict:
    return {
        "api_id": api_id,
        "event": {
            "location_type": "offline",
            "url": slug,
            "name": "Enterprise AI Summit — CIO breakfast",
            "start_at": "2026-08-01T08:00:00.000Z",
            "end_at": "2026-08-01T10:00:00.000Z",
            "timezone": "Europe/London",
            "geo_address_info": {"city": "London", "city_state": "London, England"},
        },
        "calendar": {
            "description_short": "Generative AI for corporate teams.",
        },
    }


def luma_online_item() -> dict:
    return {
        "api_id": "evt-online",
        "event": {
            "location_type": "online",
            "url": "online-only",
            "name": "Virtual AI meetup",
            "start_at": "2026-08-02T08:00:00.000Z",
            "geo_address_info": {"city": "London", "city_state": "London, England"},
        },
        "calendar": {"description_short": "LLM talks"},
    }
